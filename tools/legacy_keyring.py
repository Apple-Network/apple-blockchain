"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of apple-blockchain. To use this
...
from apple.util.errors import KeychainUserNotFound
from apple.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-apple-{CURRENT_KEY_VERSION}"  # e.g. user-apple-1.8
DEFAULT_SERVICE = f"apple-{DEFAULT_USER}"  # e.g. apple-user-apple-1.8
MAX_KEYS = 100
