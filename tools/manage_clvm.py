...
root = here.parent
cache_path = root.joinpath(".apple_cache", "manage_clvm.json")
...
from apple.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"apple"}
hashes_path = root.joinpath("apple/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("apple/wallet/puzzles")
...
main(auto_envvar_prefix="APPLE_MANAGE_CLVM")
