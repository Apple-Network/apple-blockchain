...
total_apple = 0
print("Pool address: ")
total_apple += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_apple += make_puzzle(farmer_amounts)

assert total_apple == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
