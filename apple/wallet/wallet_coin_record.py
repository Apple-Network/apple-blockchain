...
from apple.wallet.util.wallet_types import CoinType, StreamableWalletIdentifier, WalletType
from apple.wallet.vc_wallet.cr_cat_drivers import CRCATMetadata, CRCATVersion
