...
from apple.wallet.notification_store import Notification, NotificationStore
from apple.wallet.transaction_record import TransactionRecord
from apple.wallet.util.compute_memos import compute_memos_for_spend
from apple.wallet.util.notifications import construct_notification
...
class NotificationManager:
    ...
    async def send_new_notification(
        ...
        full_tx: TransactionRecord = dataclasses.replace(
            apple_tx, spend_bundle=SpendBundle.aggregate([apple_tx.spend_bundle, extra_spend_bundle])
        )
        return full_tx
