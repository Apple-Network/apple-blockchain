...
from apple.wallet.cat_wallet.cat_utils import CAT_MOD, construct_cat_puzzle
...
from apple.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from apple.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from apple.wallet.util.curry_and_treehash import curry_and_treehash
from apple.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="apple.wallet.vc_wallet.cr_puzzles",
...
class CRCAT:
    ...
    def launch(
        ...
        """
        Launch a new CR-CAT from APPLE.
