...
from apple.wallet.singleton import get_inner_puzzle_from_singleton, get_singleton_id_from_puzzle
from apple.wallet.singleton_record import SingletonRecord
