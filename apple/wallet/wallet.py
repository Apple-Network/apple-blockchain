...
from apple.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from apple.wallet.puzzles.puzzle_utils import (
...
from apple.wallet.util.wallet_types import WalletIdentifier, WalletType
...
class Wallet:
    ...
    async def sign_message(self, message: str, puzzle_hash: bytes32, mode: SigningMode) -> Tuple[G1Element, G2Element]:
        ...
        # https://github.com/Apple-Network/chips/blob/80e4611fe52b174bf1a0382b9dff73805b18b8c6/CHIPs/chip-0002.md#signmessage
    ...
    async def create_tandem_apple_tx(
        ...
        apple_coins = await self.select_coins(fee, tx_config.coin_selection_config)
        [apple_tx] = await self.generate_signed_transaction(
            uint64(0),
    ...
    # WSAppleConnection is only imported for type checking
