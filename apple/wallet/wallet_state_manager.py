...
from apple.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from apple.pools.pool_wallet import PoolWallet
from apple.protocols import wallet_protocol
from apple.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from apple.util.config import process_config_start_method
...
from apple.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
from apple.wallet.cat_wallet.cat_wallet import CATWallet
from apple.wallet.derivation_record import DerivationRecord
from apple.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_wallet_sk_unhardened
from apple.wallet.did_wallet.did_info import DID_HRP
from apple.wallet.did_wallet.did_wallet import DIDWallet
from apple.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from apple.wallet.key_val_store import KeyValStore
from apple.wallet.nft_wallet.nft_info import NFTWalletInfo
...
from apple.wallet.rl_wallet.rl_wallet import RLWallet
from apple.wallet.settings.user_settings import UserSettings
from apple.wallet.trade_manager import TradeManager
from apple.wallet.transaction_record import TransactionRecord
from apple.wallet.util.compute_hints import compute_coin_hints
from apple.wallet.util.transaction_type import TransactionType
from apple.wallet.util.wallet_sync_utils import last_change_height_cs
from apple.wallet.util.wallet_types import WalletType
from apple.wallet.wallet import Wallet
from apple.wallet.wallet_action import WalletAction
from apple.wallet.wallet_action_store import WalletActionStore
...
from apple.wallet.wallet_sync_store import WalletSyncStore
...
from apple.wallet.wallet_weight_proof_handler import WalletWeightProofHandler
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSAppleConnection, fork_height: Optional[uint32]
    ) -> None:
