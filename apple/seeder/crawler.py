...
from apple.protocols import full_node_protocol
from apple.protocols.full_node_protocol import RespondPeers
from apple.rpc.rpc_server import StateChangedProtocol, default_get_connections
from apple.seeder.crawl_store import CrawlStore
from apple.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSAppleConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSAppleConnection) -> None:
