...
from apple.rpc.rpc_server import default_get_connections
from apple.server.outbound_message import NodeType
from apple.simulator.block_tools import BlockTools
from apple.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive APPLE at an address.
