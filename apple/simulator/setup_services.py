...
from apple.cmds.init_funcs import init
from apple.consensus.constants import ConsensusConstants
from apple.daemon.server import WebSocketServer, daemon_launch_lock_path
from apple.farmer.farmer import Farmer
from apple.farmer.farmer_api import FarmerAPI
from apple.full_node.full_node import FullNode
from apple.full_node.full_node_api import FullNodeAPI
from apple.harvester.harvester import Harvester
from apple.harvester.harvester_api import HarvesterAPI
from apple.introducer.introducer import Introducer
from apple.introducer.introducer_api import IntroducerAPI
from apple.protocols.shared_protocol import Capability, capabilities
from apple.seeder.crawler import Crawler
from apple.seeder.crawler_api import CrawlerAPI
from apple.seeder.dns_server import DNSServer, create_dns_server_service
from apple.seeder.start_crawler import create_full_node_crawler_service
from apple.server.outbound_message import NodeType
from apple.server.start_farmer import create_farmer_service
from apple.server.start_full_node import create_full_node_service
from apple.server.start_harvester import create_harvester_service
from apple.server.start_introducer import create_introducer_service
from apple.server.start_service import Service
from apple.server.start_timelord import create_timelord_service
from apple.server.start_wallet import create_wallet_service
from apple.simulator.block_tools import BlockTools, test_constants
from apple.simulator.full_node_simulator import FullNodeSimulator
from apple.simulator.keyring import TempKeyring
from apple.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from apple.simulator.start_simulator import create_full_node_simulator_service
from apple.ssl.create_ssl import create_all_ssl
from apple.timelord.timelord import Timelord
from apple.timelord.timelord_api import TimelordAPI
from apple.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
from apple.types.blockchain_format.sized_bytes import bytes32
from apple.types.peer_info import UnresolvedPeerInfo
from apple.util.bech32m import encode_puzzle_hash
from apple.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from apple.util.db_wrapper import generate_in_memory_db_uri
from apple.util.ints import uint16
from apple.util.keychain import bytes_to_mnemonic
from apple.util.lock import Lockfile
from apple.util.misc import SignalHandlers
from apple.wallet.wallet_node import WalletNode
from apple.wallet.wallet_node_api import WalletNodeAPI
...
async def setup_crawler(
    ...
    service_config["other_peers_port"] = 25666
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["apple_spam_amount"] = apple_spam_amount
...
async def setup_farmer(
    ...
    service_config["apple_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "apple")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["apple_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "apple")
