...
from apple.consensus.block_record import BlockRecordProtocol
from apple.consensus.constants import ConsensusConstants
from apple.consensus.cost_calculator import NPCResult
from apple.full_node.bitcoin_fee_estimator import create_bitcoin_fee_estimator
from apple.full_node.bundle_tools import simple_solution_generator
from apple.full_node.fee_estimation import FeeBlockInfo, MempoolInfo, MempoolItemInfo
from apple.full_node.fee_estimator_interface import FeeEstimatorInterface
from apple.full_node.mempool import MEMPOOL_ITEM_FEE_LIMIT, Mempool, MempoolRemoveReason
from apple.full_node.mempool_check_conditions import get_name_puzzle_conditions, mempool_check_time_locks
from apple.full_node.pending_tx_cache import ConflictTxCache, PendingTxCache
from apple.types.blockchain_format.coin import Coin
from apple.types.blockchain_format.sized_bytes import bytes32, bytes48
from apple.types.clvm_cost import CLVMCost
from apple.types.coin_record import CoinRecord
from apple.types.fee_rate import FeeRate
from apple.types.mempool_inclusion_status import MempoolInclusionStatus
from apple.types.mempool_item import BundleCoinSpend, MempoolItem
from apple.types.spend_bundle import SpendBundle
from apple.types.spend_bundle_conditions import SpendBundleConditions
from apple.util import cached_bls
from apple.util.cached_bls import LOCAL_CACHE
from apple.util.condition_tools import pkm_pairs
from apple.util.db_wrapper import SQLITE_INT_MAX
from apple.util.errors import Err, ValidationError
from apple.util.inline_executor import InlineExecutor
from apple.util.ints import uint32, uint64
from apple.util.lru_cache import LRUCache
from apple.util.setproctitle import getproctitle, setproctitle

log = logging.getLogger(__name__)

# mempool items replacing existing ones must increase the total fee at least by
# this amount. 0.00001 APPLE
...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 APPLE per block, or about 0.00005 APPLE for two
        # spends.
