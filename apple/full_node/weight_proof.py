...
from apple.consensus.block_header_validation import validate_finished_header_block
...
from apple.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from apple.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
from apple.types.blockchain_format.sub_epoch_summary import SubEpochSummary
from apple.types.blockchain_format.vdf import VDFInfo, VDFProof, validate_vdf
from apple.types.end_of_slot_bundle import EndOfSubSlotBundle
from apple.types.header_block import HeaderBlock
from apple.types.weight_proof import (
    RecentChainData,
...
def _create_shutdown_file() -> IO[bytes]:
    return tempfile.NamedTemporaryFile(prefix="apple_full_node_weight_proof_handler_executor_shutdown_trigger")
