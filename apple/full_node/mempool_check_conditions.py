...
from apple.full_node.generator import create_generator_args, setup_generator_args
from apple.types.blockchain_format.coin import Coin
from apple.types.blockchain_format.program import NIL
...
from apple.util.clvm import int_from_bytes, int_to_bytes
from apple.util.condition_tools import ConditionOpcode, conditions_by_opcode
from apple.util.errors import Err, ValidationError
from apple.util.ints import uint32, uint64, uint16
from apple.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
from apple.wallet.puzzles.rom_bootstrap_generator import get_generator
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see apple/types/blockchain_format/program.py)
