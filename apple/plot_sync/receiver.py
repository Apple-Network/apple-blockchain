...
from apple.consensus.pos_quality import UI_ACTUAL_SPACE_CONSTANT_FACTOR, _expected_plot_size
from apple.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from apple.plot_sync.exceptions import (
...
from apple.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from apple.plotting.util import HarvestingMode
...
from apple.util.ints import int16, uint32, uint64
from apple.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSAppleConnection:
