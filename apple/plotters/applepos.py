"""
NOTE: This contains duplicate code from `apple.cmds.plots`.
After `apple plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
...
def get_applepos_install_info() -> Optional[Dict[str, Any]]:
    applepos_version: str = pkg_resources.get_distribution("chiapos").version
    return {"display_name": "Apple Proof of Space", "version": applepos_version, "installed": True}
