import os
from apple.plotters.bladebit import install_bladebit
from apple.plotters.madmax import install_madmax
...
def install_plotter(plotter, root_path):
    if plotter == "applepos":
        ...
        if not os.path.exists(root_path / "madmax-plotter/build/apple_plot"):
