...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Apple versions use "
...
@keys_cmd.command("migrate", short_help="Attempt to migrate keys to the Apple keyring")
@click.pass_context
...
@click.option("--prefix", "-x", help="Address prefix (apple for mainnet, tapple for testnet)", default=None, type=str)
@click.option(
    "--non-observer-derivation",
    "-d",
