...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(apple complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33mapple complete generate > ~/.apple-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.apple-complete-bash\033[0m
    """
    ...
    subprocess.run(["apple"], check=True, env={**os.environ, "_APPLE_COMPLETE": f"{shell}_source"})
