...
from apple.util.collection import find_duplicates
from apple.util.db_synchronous import db_synchronous_on
from apple.util.db_wrapper import DBWrapper2, execute_fetchone
from apple.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Apple wallet databases.
    The core apple client currently uses sqlite to store the wallet databases, one database per key.
\b
