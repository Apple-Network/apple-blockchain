...
from apple.cmds.cmds_util import NODE_TYPES
from apple.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Apple service to ip:port", type=str, default="")
@click.option(
