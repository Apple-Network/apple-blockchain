    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "25666"
                testnet_introducer = "introducer-testnet0.applecoin.in"
                testnet_dns_introducer = "dns-introducer-testnet0.applecoin.in"
                bootstrap_peers = ["testnet0-node.applecoin.in"]
                testnet = "testnet0"
                ...
                bootstrap_peers = ["node.applecoin.in"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running apple services for changes to take effect")
