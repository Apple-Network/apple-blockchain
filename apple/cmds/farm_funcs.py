...
from apple.util.misc import format_bytes, format_minutes
from apple.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total apple farmed: {amounts['farmed_amount'] / units['apple']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['apple']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['apple']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'apple start wallet' and 'apple wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'apple wallet show'")
    else:
        print("Note: log into your key using 'apple wallet show' to see rewards for each key")
