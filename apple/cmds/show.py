...
from apple.cmds.show_funcs import show_async
...
def show_cmd(
    ...
    if connections:
        print("'apple show -c' has been renamed to 'apple peer full_node -c' ")
    if add_connection != "":
        print("'apple show -a' has been renamed to 'apple peer full_node -a' ")
    if remove_connection != "":
        print("'apple show -r' has been renamed to 'apple peer full_node -r' ")
    if wallet_rpc_port is not None:
        print("'apple show -wp' is not used, please remove it from your command.")
    asyncio.run(
        show_async(
            rpc_port,
            ctx.obj["root_path"],
