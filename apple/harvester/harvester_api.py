...
from apple.plotting.util import PlotInfo, parse_plot_info
from apple.protocols import harvester_protocol
from apple.protocols.farmer_protocol import FarmingInfo
from apple.protocols.harvester_protocol import Plot, PlotSyncResponse
from apple.protocols.protocol_message_types import ProtocolMessageTypes
from apple.server.outbound_message import make_msg
...
from apple.util.ints import uint8, uint32, uint64
from apple.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSAppleConnection
    ):
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSAppleConnection
    ):
        """
