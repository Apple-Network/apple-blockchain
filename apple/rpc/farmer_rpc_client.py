...
from apple.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from apple.rpc.rpc_client import RpcClient
from apple.types.blockchain_format.sized_bytes import bytes32
from apple.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Apple RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
