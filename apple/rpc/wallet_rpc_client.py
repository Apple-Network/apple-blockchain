...
from apple.data_layer.data_layer_wallet import Mirror, SingletonRecord
from apple.pools.pool_wallet_info import PoolWalletInfo
from apple.rpc.rpc_client import RpcClient
...
from apple.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
from apple.wallet.util.query_filter import TransactionTypeFilter
...
from apple.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    """
    Client to Apple RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        apple_coins: Optional[List[Dict]] = None,
        apple_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "apple_change_target": apple_change_target,
