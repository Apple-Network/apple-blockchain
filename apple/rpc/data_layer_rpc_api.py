...
from apple.data_layer.data_layer_errors import OfferIntegrityError
...
from apple.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from apple.rpc.data_layer_rpc_util import marshal
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "apple_data_layer"
