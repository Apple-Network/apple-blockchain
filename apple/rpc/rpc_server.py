...
from apple.rpc.util import wrap_http_handler
from apple.server.outbound_message import NodeType
from apple.server.server import AppleServer, ssl_context_for_client, ssl_context_for_server
...
from apple.util.config import str2bool
from apple.util.ints import uint16
from apple.util.json_util import dict_to_json_str
from apple.util.network import WebServer, resolve
from apple.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> AppleServer:
        ...
        # a property so as to be read only which allows AppleServer to satisfy
        # Optional[AppleServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        apple.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: AppleServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
