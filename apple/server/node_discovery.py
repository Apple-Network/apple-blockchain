...
from apple.protocols import full_node_protocol, introducer_protocol
...
from apple.types.peer_info import PeerInfo, TimestampedPeerInfo
...
class FullNodeDiscovery:
    ...
    async def on_connect(self, peer: ws.WSAppleConnection):
        if (
    ...
    async def update_peer_timestamp_on_message(self, peer: ws.WSAppleConnection):
        if (
            peer.is_outbound
            and peer.peer_server_port is not None
            and peer.connection_type is NodeType.FULL_NODE
    ...
    async def _introducer_client(self):
        ...
        async def on_connect(peer: ws.WSAppleConnection):
    ...
    async def on_connect_callback(self, peer: ws.WSAppleConnection):
