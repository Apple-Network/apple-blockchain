...
from apple.consensus.default_constants import DEFAULT_CONSTANTS, update_testnet_overrides
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("APPLE_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_apple_loop_policy", True):
            target_peer_count = None
