...
from apple.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from apple.protocols.shared_protocol import Capability, Handshake
...
from apple.util.ints import uint8, uint16
