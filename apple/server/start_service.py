...
from apple.daemon.server import singleton, service_launch_lock_path
...
from apple.rpc.rpc_server import start_rpc_server
...
from apple.util.config import load_config, load_config_cli
...
class Service:
    def __init__(
        ...
        proctitle_name = f"apple_{service_name_prefix}{service_name}"
