...
If you want to learn more about this project, read the [wiki](https://github.com/Apple-Network/apple-blockchain/wiki), or check out the [green paper](https://www.chia.net/assets/AppleGreenPaper.pdf).
