...
required to run a [Timelord](https://github.com/Apple-Network/apple-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/Apple-Network/apple-blockchain/blob/main/install-timelord.sh)
