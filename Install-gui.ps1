...
{
    Write-Output "This script requires that the Apple Python virtual environment is activated."
...
Push-Location
try {
    Set-Location apple-blockchain-gui
    ...
    Write-Output ""
    Write-Output "Apple blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd apple-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
