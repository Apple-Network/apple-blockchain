...
Write-Output "   ---"
# download.applecoin.in is the CDN url behind all the files that are actually on pypi.chia.net/simple now
...
Write-Output "pip install apple-blockchain"
pip install --no-index --find-links=.\win_build\ apple-blockchain
